...
public class PlayServicesInstallation {
	public enum CheckResult {
		SUCCESS, CANCELLED, ERROR, USER_ERROR
	}
	 ...
	 */
	public static CheckResult checkPlayServicesExist(final Context context) {
		...
		if (apiAvailability.isUserResolvableError(resultCode)) {
			return CheckResult.USER_ERROR;
		}

		return resultCode == ConnectionResult.SUCCESS ? CheckResult.SUCCESS : CheckResult.ERROR;
	}

	public static void showInstallationDialog(final Context context) {
