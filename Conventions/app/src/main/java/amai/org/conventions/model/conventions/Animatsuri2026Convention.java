...
//		imageMapper.addMapping(ImageIdToImageResourceMapper.EVENT_GENERIC, R.drawable.event_activity_background);
	...
	private ConventionMap createMap() {
		...
		Floor entrance = new Floor(1)
				.withName("מתחם כניסה")
				.withImageResource(R.drawable.harucon2026_floor_entrance, false)
				.withImageWidth(1985.652f)
				.withImageHeight(1261.588f);
		Floor floor1 = new Floor(2)
				.withName("קומה 1")
				.withImageResource(R.drawable.harucon2026_floor1, false)
				.withImageWidth(1848.479f)
				.withImageHeight(1301f);
		Floor floor2 = new Floor(3)
				.withName("קומה 2")
				.withImageResource(R.drawable.harucon2026_floor2, false)
						...
						CollectionUtils.flattenList(
								inFloor(entrance,
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_info_entrance, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_info_entrance, false)
												.withMarkerHeight(202.165f)
												.withX(1310.462f)
												.withY(892.265f),
										new MapLocation()
												.withPlace(new Place().withName("עמדת צימוד"))
												.withMarkerResource(R.drawable.harucon2026_marker_bracelets, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_bracelets, false)
												.withMarkerHeight(92.439f)
												.withX(947.8445f)
												.withY(912.991f),
										new MapLocation()
												.withPlace(new Place().withName("קופות"))
												.withMarkerResource(R.drawable.harucon2026_marker_cashier, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_cashier, false)
												.withMarkerHeight(92.439f)
												.withX(713.8445f)
												.withY(875.991f),
										new MapLocation()
												.withPlace(new Place().withName(ACCESSIBLE_CASHIERS_NAME))
												.withMarkerResource(R.drawable.harucon2026_marker_accessible_cashier, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_accessible_cashier, false)
												.withMarkerHeight(92.439f)
												.withX(933.8445f)
												.withY(724.991f),
										new MapLocation()
												.withPlace(new Place().withName("מתחם הזמנה מראש"))
												.withMarkerResource(R.drawable.harucon2026_marker_preorders, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_preorders, false)
												.withMarkerHeight(92.439f)
												.withX(972.3445f)
												.withY(433.991f),
										new MapLocation()
												.withPlace(new Place().withName("מתחם קנייה במקום"))
												.withMarkerResource(R.drawable.harucon2026_marker_purchase, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_purchase, false)
												.withMarkerHeight(92.439f)
												.withX(497.3445f)
												.withY(695.991f),
										new MapLocation()
												.withPlace(new Place().withName("מעבר נגיש"))
												.withMarkerResource(R.drawable.harucon2026_marker_accessible_passage, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_accessible_passage, false)
												.withMarkerHeight(92.439f)
												.withX(339.8445f)
												.withY(427.991f)
								),
								inFloor(floor1,
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_toilet, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_toilet, false)
												.withMarkerHeight(101.949f)
												.withX(1562.6f)
												.withY(693.051f),
										new MapLocation()
												.withPlace(oranim)
												.withMarkerResource(R.drawable.harucon2026_marker_oranim, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_oranim, false)
...
//												.withMarkerResource(R.drawable.harucon2026_marker_oranim2, false)
//												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_oranim2, false)
...
//												.withY(859.33f),
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_stands, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_stands, false)
										...
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_food_court, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_food_court, false)
										...
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_games, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_games, false)
												.withMarkerHeight(129.828f)
												.withX(1298.979f)
												.withY(364.086f),
										new MapLocation()
												.withPlace(new Place().withName("מתחם נינטנדו").withShelter(true))
												.withMarkerResource(R.drawable.harucon2026_marker_nintendo, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_nintendo, false)
												.withMarkerHeight(114.037f)
												.withX(1294.234f)
												.withY(247.963f),
										new MapLocation()
												.withPlace(new Place().withName("שמירת חפצים").withShelter(true))
												.withMarkerResource(R.drawable.harucon2026_marker_storage, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_storage, false)
												.withMarkerHeight(128.037f)
												.withX(1122.234f)
												.withY(237.963f),
										new MapLocation()
												.withPlace(new Place().withName("מודיעין ודוכן אמא\"י"))
												.withMarkerResource(R.drawable.harucon2026_marker_info, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_info, false)
										...
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_elevator, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_elevator, false)
												.withMarkerHeight(85.813f)
												.withX(827.152f)
												.withY(233.282f),
										new MapLocation()
												.withPlace(eshkol3)
												.withMarkerResource(R.drawable.harucon2026_marker_eshkol3, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_eshkol3, false)
												.withMarkerHeight(123.67f)
												.withX(376.4045f)
												.withY(778.33f),
										new MapLocation()
												.withPlace(eshkol2)
												.withMarkerResource(R.drawable.harucon2026_marker_eshkol2, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_eshkol2, false)
												.withMarkerHeight(123.67f)
												.withX(540.4055f)
												.withY(778.33f),
										new MapLocation()
												.withPlace(eshkol1)
												.withMarkerResource(R.drawable.harucon2026_marker_eshkol1, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_eshkol1, false)
												.withMarkerHeight(123.669f)
												.withX(500.4055f)
												.withY(595.008f),
										new MapLocation()
												.withPlace(new FloorLocation().withFloor(floor2).withName("מעבר לקומה 2"))
												.withMarkerResource(R.drawable.harucon2026_marker_goto_floor2, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_goto_floor2, false)
								...
								inFloor(floor2,
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_cosplay_judgement, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_cosplay_judgement, false)
												.withMarkerHeight(113.011f)
												.withX(1305.49f)
												.withY(874.509f),
//										new MapLocation()
//												.withPlace(workshops)
//												.withMarkerResource(R.drawable.harucon2026_marker_workshops, false)
//												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_workshops, false)
//												.withMarkerHeight(111.82f)
//												.withX(1454.525f)
//												.withY(943.44f),
										new MapLocation()
												.withPlace(new Place().withName(CHILDREN_ROOM_NAME))
												.withMarkerResource(R.drawable.harucon2026_marker_parents_room, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_parents_room, false)
										...
										new MapLocation()
												.withPlace(mainHall)
												.withMarkerResource(R.drawable.harucon2026_marker_main_hall, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_main_hall, false)
												.withMarkerHeight(156f)
												.withX(1183.975f)
												.withY(592.26f),
										new MapLocation()
												.withPlace(new Place().withName("כניסה נגישה לאולם ראשי"))
												.withMarkerResource(R.drawable.harucon2026_marker_main_hall_accessible_entrance, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_main_hall_accessible_entrance, false)
												.withMarkerHeight(98.353f)
												.withX(1312.105f)
												.withY(480.907f),
										new MapLocation()
												.withPlace(cosplayArea)
												.withMarkerResource(R.drawable.harucon2026_marker_cosplay_area, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_cosplay_area, false)
										...
										new MapLocation()
												...
												.withPlace(agam)
												.withMarkerResource(R.drawable.harucon2026_marker_artist_alley, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_artist_alley, false)
										...
										new MapLocation()
												...
												.withMarkerResource(R.drawable.harucon2026_marker_goto_floor1, false)
												.withSelectedMarkerResource(R.drawable.harucon2026_selected_marker_goto_floor1, false)
