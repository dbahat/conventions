...
public class DiscountsActivity extends NavigationActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Handle edge to edge
		Views.registerApplyInsets(Views.InsetType.NONE, Views.InsetType.NONE, Views.InsetType.PADDING, Views.InsetType.PADDING, findViewById(R.id.discounts_scroll));
