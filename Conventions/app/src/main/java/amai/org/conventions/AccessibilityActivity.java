...
import amai.org.conventions.model.conventions.Harucon2025Convention;
        ...
        if (intentData != null && intentData.getPath() != null) {
            switch (intentData.getPath().intern()) {
                ...
                case "/open-map-in-parent-room": {
                    ...
                    List<MapLocation> locations = map.findLocationsByName(Harucon2025Convention.CHILDREN_ROOM_NAME);
