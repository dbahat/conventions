...
//				new Stand().withName("דוכן יד 2").withType(StandType.MERCH).withLocationName("e21").withImageX(612).withImageY(438),
	...
	private List<Stand> getAgamStands() {
		return Arrays.asList(
				...
				new Stand().withName("החוג ללימודי מזרח אסיה - המכללה האקדמית תל-חי").withType(StandType.OTHER).withLocationName("a9").withImageX(807).withImageY(204),
				new Stand().withName("אמאטראסו").withType(StandType.MERCH).withLocationName("a10").withImageX(854).withImageY(204),
				new Stand().withName("ארבע אצבעות").withType(StandType.OTHER).withLocationName("a11-12").withImageX(934).withImageY(204),
				new Stand().withName("הממלכה").withType(StandType.TABLETOP_GAMES).withLocationName("a13-14").withImageX(1038).withImageY(204),
				new Stand().withName("קומיקאזה").withType(StandType.MANGA).withLocationName("a15-17").withImageX(1220).withImageY(204),
