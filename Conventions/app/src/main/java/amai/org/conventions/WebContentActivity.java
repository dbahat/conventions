...
public abstract class WebContentActivity extends NavigationActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Handle edge to edge
		Views.registerApplyInsets(Views.InsetType.NONE, Views.InsetType.NONE, Views.InsetType.PADDING, Views.InsetType.PADDING, false, findViewById(R.id.web_content_scroll));
