...
public class Harucon2024Convention extends AmaiConvention {
	...
	protected URL initUpdatesURL() {
		try {
			return new URL("https://harucon.org.il/2024/wp-content/plugins/get-harucon-feed.php");
...
//		);
	...
	private ConventionMap createMap() {
		...
		StandsArea agam = new StandsArea()
				...
				.withImageResource(R.drawable.harucon2024_stands_map_agam)
				.withImageWidth(1545)
				.withImageHeight(662);
		StandsArea pinkus = new StandsArea()
				...
				.withImageResource(R.drawable.harucon2024_stands_map_pinkus)
				.withImageWidth(934)
				.withImageHeight(564);
	...
	private List<Stand> getPinkusStands() {
		return Arrays.asList(
			...
			new Stand().withName("שני לימונים").withType(StandType.CLOTHES).withLocationIds("c37", "c38"),
			new Stand().withName("סטימצקי").withType(StandType.MANGA).withLocationIds("c39", "c40", "c41", "c42", "c43", "c44", "c45", "c46", "c47", "c48", "c49", "c50"),
			new Stand().withName("Candy Lenses").withType(StandType.CLOTHES).withLocationIds("c4", "c5", "c6"),
			...
			new Stand().withName("Anime Storm (אנימה סטורם)").withType(StandType.CLOTHES).withLocationIds("d3", "d4", "d5", "d6"),
			new Stand().withName("YK crochet").withType(StandType.OTHER).withLocationIds("d7", "d8"),
			new Stand().withName("Akinapaz").withType(StandType.MERCH).withLocationIds("d9", "d10", "d11", "d12"),
			new Stand().withName("Otaku and Fujoushi").withType(StandType.MERCH).withLocationIds("e1", "e2"),
			new Stand().withName("SweetheartYun").withType(StandType.CLOTHES).withLocationIds("e11", "e12"),
			new Stand().withName("Raspberry").withType(StandType.CLOTHES).withLocationIds("e13", "e14"),
			new Stand().withName("קימבי").withType(StandType.MERCH).withLocationIds("e15"),
			new Stand().withName("Noyanny").withType(StandType.CLOTHES).withLocationIds("e16"),
			new Stand().withName("Aniverse").withType(StandType.CLOTHES).withLocationIds("e17", "e18"),
			new Stand().withName("המרכז ללימודי יפנית").withType(StandType.OTHER).withLocationIds("e19", "e20"),
			new Stand().withName("Laser i con").withType(StandType.MERCH).withLocationIds("e21", "e22"),
			new Stand().withName("iDolls Collection").withType(StandType.MERCH).withLocationIds("e23", "e24"),
			new Stand().withName("N FIG").withType(StandType.MERCH).withLocationIds("e3", "e4", "e5", "e6"),
			new Stand().withName("אורלי קסם").withType(StandType.CLOTHES).withLocationIds("e7"),
			new Stand().withName("Japaneasy").withType(StandType.OTHER).withLocationIds("e8"),
			new Stand().withName("frozen flawers").withType(StandType.OTHER).withLocationIds("e9", "e10")
		);
	}
	...
	private List<Stand> getAgamStands() {
		return Arrays.asList(
			...
			new Stand().withName("Paludu's").withType(StandType.CLOTHES).withLocationIds("a10", "a11", "a12"),
			...
			new Stand().withName("Topdeck").withType(StandType.OTHER).withLocationIds("a33", "a34", "a35", "a36"),
			new Stand().withName("Anime Wave").withType(StandType.MERCH).withLocationIds("a37", "a38", "a39", "a40", "a41", "a42"),
			new Stand().withName("קי\"ק - קבוצת יצירת קומיקס").withType(StandType.MANGA).withLocationIds("a43", "a44"),
			new Stand().withName("TVfox").withType(StandType.OTHER).withLocationIds("a45", "a46"),
			new Stand().withName("MiniTokio").withType(StandType.MERCH).withLocationIds("a5", "a6", "a7", "a8"),
			new Stand().withName("Art_studio_handmade").withType(StandType.OTHER).withLocationIds("a9"),
			new Stand().withName("Nighto").withType(StandType.ARTIST).withLocationIds("b1"),
			new Stand().withName("Kotikish").withType(StandType.ARTIST).withLocationIds("b11"),
			new Stand().withName("Art Café").withType(StandType.ARTIST).withLocationIds("b12"),
			new Stand().withName("sha2").withType(StandType.ARTIST).withLocationIds("b13"),
			new Stand().withName("Anipug").withType(StandType.ARTIST).withLocationIds("b14"),
			...
			new Stand().withName("Mariliya").withType(StandType.ARTIST).withLocationIds("b18", "b19"),
			new Stand().withName("דוכן האמן של ליאן").withType(StandType.ARTIST).withLocationIds("b2", "b3"),
			new Stand().withName("gabisweb").withType(StandType.ARTIST).withLocationIds("b20"),
			new Stand().withName("kaboodel").withType(StandType.ARTIST).withLocationIds("b21", "b22"),
			new Stand().withName("eladb_art").withType(StandType.ARTIST).withLocationIds("b23"),
			new Stand().withName("Tomatoes Trash").withType(StandType.ARTIST).withLocationIds("b24"),
			new Stand().withName("Sharki00").withType(StandType.ARTIST).withLocationIds("b25"),
			new Stand().withName("מקרר").withType(StandType.ARTIST).withLocationIds("b26", "b27"),
			new Stand().withName("Kimichu.x").withType(StandType.ARTIST).withLocationIds("b28"),
			new Stand().withName("Cryptic arts").withType(StandType.ARTIST).withLocationIds("b29", "b30"),
			new Stand().withName("Meiiior").withType(StandType.ARTIST).withLocationIds("b31"),
			new Stand().withName("ro._.chan").withType(StandType.ARTIST).withLocationIds("b32"),
			new Stand().withName("kukeshii").withType(StandType.ARTIST).withLocationIds("b33"),
			new Stand().withName("Grisim").withType(StandType.ARTIST).withLocationIds("b34", "b35"),
			new Stand().withName("Shourterthan").withType(StandType.ARTIST).withLocationIds("b36", "b37"),
			new Stand().withName("The Chip Club").withType(StandType.ARTIST).withLocationIds("b38"),
			new Stand().withName("crimson soda").withType(StandType.ARTIST).withLocationIds("b39"),
			new Stand().withName("הדוכן המדליק של אריאל").withType(StandType.ARTIST).withLocationIds("b4"),
			new Stand().withName("Eli Zeroix").withType(StandType.ARTIST).withLocationIds("b40"),
			new Stand().withName("SHANDRWA").withType(StandType.ARTIST).withLocationIds("b41"),
			new Stand().withName("Almogolan art").withType(StandType.ARTIST).withLocationIds("b42"),
			new Stand().withName("פרעושים ופשפשים").withType(StandType.ARTIST).withLocationIds("b43"),
			new Stand().withName("Shokolyr").withType(StandType.ARTIST).withLocationIds("b44"),
			new Stand().withName("Elmiellart").withType(StandType.ARTIST).withLocationIds("b45"),
			new Stand().withName("koruhiko").withType(StandType.ARTIST).withLocationIds("b46", "b47"),
			new Stand().withName("Ozart").withType(StandType.ARTIST).withLocationIds("b48", "b49"),
			new Stand().withName("B4RMN").withType(StandType.ARTIST).withLocationIds("b5", "b6"),
			new Stand().withName("Orchibald art").withType(StandType.ARTIST).withLocationIds("b50", "b51"),
			new Stand().withName("Meitlavi95").withType(StandType.ARTIST).withLocationIds("b52"),
	...
	private StandLocations getAgamStandLocations() {
		...
		// Bottom right column
		float a4Left = 209.500f;
		float a4Top = 292.500f;
		...
		float b41Top = 228.500f;
		float b42Left = 1037.000f;
		float b42Top = 185.000f;
		float b46Left = 1154.000f;
		float b46Top = 215.000f;
		...
		return new StandLocations(
				...
				StandLocation.fromWidths("b46", "b46", "b47", b46Left, defaultWidth, b46Top, defaultHeight),
				StandLocation.fromWidths("b47", "b47", "b48", b46Left, defaultWidth, b46Top + (defaultHeight + defaultSpaceVertical), defaultHeight),
				StandLocation.fromWidths("b48", "b48", "b49", b46Left, defaultWidth, b46Top + 2*(defaultHeight + defaultSpaceVertical), defaultHeight),
				StandLocation.fromWidths("b49", "b49", "b50", b46Left, defaultWidth, b46Top + 3*(defaultHeight + defaultSpaceVertical), defaultHeight),
				StandLocation.fromWidths("b50", "b50", "b51", b46Left, defaultWidth, b46Top + 4*(defaultHeight + defaultSpaceVertical), defaultHeight),
				StandLocation.fromWidths("b51", "b51", "b52", b46Left, defaultWidth, b46Top + 5*(defaultHeight + defaultSpaceVertical), defaultHeight),
	...
	private StandLocations getPinkusStandLocations() {
		...
		float c9Left = 460.000f;
		float c9Top = 105.000f;
		float c13Left = 594.000f;
		float c13Top = 105.000f;

		// Right column
		float c23Left = 832.000f;
		float c23Top = 187.000f;

		// Bottom row
		float c36Left = 702.000f;
		float c36Top = 461.000f;
		float c42Left = 524.000f;
		float c42Top = 461.000f;
		float c48Left = 346.000f;
		float c48Top = 461.000f;

		// Bottom left column
		float c50Left = 320.000f;
		float c50Top = 485.000f;
		...
		return new StandLocations(
				...
				StandLocation.fromWidths("c37", "c37", "c38", c42Left + 5*(defaultWidth + defaultSpaceHorizontal), defaultWidth, c42Top, defaultHeight),
				StandLocation.fromWidths("c38", "c38", "c39", c42Left + 4*(defaultWidth + defaultSpaceHorizontal), defaultWidth, c42Top, defaultHeight),
				...
				StandLocation.fromWidths("c49", "c49", "c50", c50Left, defaultWidth, c50Top + (defaultHeight + defaultSpaceVertical), defaultHeight),
				StandLocation.fromWidths("c50", "c50", null, c50Left, defaultWidth, c50Top, defaultHeight),
